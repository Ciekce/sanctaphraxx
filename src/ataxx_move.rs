...
mod tests {
    ...
    #[test]
    fn pack_single() {
        let mv = AtaxxMove::Single(Square::B6);
        assert_eq!(mv.pack().raw(), 0b10_000000_101001);
    }

    #[test]
    fn pack_double() {
        let mv = AtaxxMove::Double(Square::B5, Square::A7);
        assert_eq!(mv.pack().raw(), 0b11_100001_110000);
    }
